...
export class AtractivoRouter extends BaseRouter<AtractivoController>{
    ...
    routes():void{
        ...
        this.router.put('/updateAtractivo/:id',uploadEdit,(req,res)=>this.controller.updateAtractivo(req,res));
        //this.router.post('/createAtractivo',(req,res)=>this.controller.createAtractivo(req,res));
        this.router.post('/createAtractivo',upload,(req,res)=>this.controller.createAtractivo(req,res));
